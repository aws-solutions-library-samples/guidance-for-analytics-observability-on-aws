    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        emr_pipeline = dsf.processing.SparkEmrServerlessJob(self, 'TpcdsJob', 
            dsf.processing.SparkEmrServerlessJobProps(
                ...
                spark_submit_parameters=f"--conf spark.driver.extraJavaOptions=-Dlog4j2.contextSelector=org.apache.logging.log4j.core.async.AsyncLoggerContextSelector --conf spark.executor.extraJavaOptions=-Dlog4j2.contextSelector=org.apache.logging.log4j.core.async.AsyncLoggerContextSelector  --conf spark.metrics.region={stack.region} --conf spark.metrics.endpoint={metrics_ingestion_url} --conf spark.metrics.batchSize=400 --conf spark.metrics.timeThreshold=60 --conf spark.dynamicAllocation.initialExecutors=20 --conf spark.plugins=com.amazonaws.sparkobservability.ObservabilityPlugin --class com.amazonaws.eks.tpcds.BenchmarkSQL",
