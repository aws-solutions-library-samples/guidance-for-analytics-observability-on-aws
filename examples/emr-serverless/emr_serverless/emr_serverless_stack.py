                                                  ...
                                                  parameters={
                                                      ...
                                                      "JobDriver": {
                                                          "SparkSubmit": {
                                                              ...
                                                              "SparkSubmitParameters": f"--conf spark.extraListeners=com.amazonaws.sparkobservability.CustomMetricsListener --conf spark.metrics.region={stack.region} --conf spark.metrics.endpoint=https://{metrics_ingestion_url}/ingest --conf spark.metrics.batchSize=50 --class com.amazonaws.eks.tpcds.BenchmarkSQL"
                                                          },
                                                      }
                                                  },
                                                  result_selector={
